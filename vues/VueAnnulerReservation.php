                        ...
                        <div data-role="content">
                                ...
                                <form action="index.php?action=AnnulerReservation" method="post" data-ajax="false">
                                        <div data-role="fieldcontain" class="ui-hide-label">
                                                ...
                                                <input type="text" name="txtIdReservation" id="txtIdReservation" placeholder="Entrez le numéro de réservation" value="">
                                        </div>
                                        <div data-role="fieldcontain">
                                                <input type="submit" name="btnAnnulerRéservation" id="btnAnnulerRéservation" value="Annuler la réservation" data-mini="true">
                                        </div>
                                </form>
                        </div>
