<?php
// Service web du projet ConsulterSalle M2L
// Ecrit le 19/12/2017 par Jim
// Modifié le 19/12/2017 par Jim

// Ce service web permet à un utilisateur de consulter les salles disponibles
    ...
    if ( $dao->getNiveauUtilisateur($nom, $mdp) == "inconnu" )
        ...
        {	// mise à jour de la table mrbs_entry_digicode (si besoin) pour créer les digicodes manquants
            ...
            $nbReponses = sizeof($lesSalles);
                    ...
                    $msg = "Il y a " . $nbReponses . " salles disponibles en réservation.";
        }
